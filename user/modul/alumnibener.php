...
echo "<table>
	<td width='20'>NO</td><td width='50'>NIS</td><td width='500'>NAMA</td><td width='70'></td>";
	$no=1;
...
case "tambah":
	...
	if($move){
		$sql=("INSERT INTO data_siswa(nis,nama,id_jur,alamat,no_hp,email,id_thun_lulus,kegiatan,nama_perusahaan,nama_perguruan_tinggi,foto_siswa,kritik_saran) 
