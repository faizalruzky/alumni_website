...
?>
		<form action="" method="post">
			<p><b>Nama Lengkap :</b><br><input type="text" name="nama" placeholder="Alumni SMAN 1 Cikarang Utara" required /></p>
			<p><b>Email :</b><br><input type="text" name="email" placeholder="alumni@sman1cikarang.sch.id" required /></p>
			<p><b>Website :</b><br><input type="text" name="website" placeholder="http://www.alumni.sman1cikarangutara.sch.id" /></p>
