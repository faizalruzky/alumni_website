...
<input type=button class='btn-success' value='Tambah Beasiswa' onclick=\"window.location.href='?page=beasiswa&aksi=tambahbea';\">";
echo "<table>
...
echo "<form action='?page=beasiswa&aksi=tambah' method='post' enctype=\"multipart/form-data\" >
    <table>
        ...
        <tr>
            <td>Nama</td>
            <td><input name=nama type=text size=55 required></td>
        </tr>
        <tr>
            <td>Data</td>
