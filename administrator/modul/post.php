...
<input type=button class='btn-success' value='Tambah Berita' onclick=\"window.location.href='?page=berita&aksi=tambahberita';\">";
echo "<table>
...
case "tambahberita":
//Form Tambah Berita
echo "<center><h2>Tambah Berita</h2></center>";
echo "<form action='?page=berita&aksi=tambah' method='post' enctype=\"multipart/form-data\" >
    ...
    <center><table>
        ...
        <tr>
            <td>Judul</td>
            <td><input name=judul type=text size=55 required></td>
        </tr>
        <tr>
            <td>Kategori</td>
        ...
        <tr>
            <td>Posting</td>
            <td><input name=posting type=text size=25 required></td>
        </tr>
        <tr>
