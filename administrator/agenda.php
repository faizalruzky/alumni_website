...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body onload="agenda('','')">
        ...
        <form id="form1" name="form1" method="post" action="index.php?t=agenda">
			Bulan :
         	<?php 
				$tgl_hari_ini=date('d');
				$bln_skr= date('m');
		...
		<i>*Klik salah satu tanggal untuk melihat maupun membuat Agenda. Warna Hijau pada tanggal menandakan tanggal hari ini. Warna Kuning menandakan ada agenda di tanggal tersebut.</i><br />
        <div id="clear"></div>
        </div>
        
        <div id="agenda">
            Agenda <span id="tanggal_agenda"></span> : <br />
            <form id="form2" name="form2" method="post" action="index.php?t=agenda">
                ...
                <input name="isi_agenda" type="text" id="isi_agenda" value="" size="30" maxlength="150" />
                <br />
